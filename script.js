...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (phoneHeaderBtn) {
    phoneHeaderBtn.addEventListener('click', function() {
      const phoneNumber = '+972542600266';
      ...
      if (window.zappyContactFormLoaded) {
        (async function() {
          try {
            ...
            const zappyPayload = {
              websiteId: '07ad4f37-f46a-4d47-947f-83058e7bd19f',
              name: fullName,
              email: email,
              subject: serviceType || 'Contact Form Submission',
              message: message,
              phone: phone || null
            };
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SAMUI משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
